namespace eval ::optrace {
  variable script "C:/enosim/IMS/project_1/project_1.runs/impl_1/top_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/enosim/IMS/project_1/project_1.cache/wt [current_project]
