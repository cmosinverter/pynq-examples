...
HD_PWD='C:/enosim/IMS/project_1/project_1.runs/top_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_processing_system7_0_0.tcl
