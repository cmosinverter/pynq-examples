...
HD_PWD='C:/enosim/IMS/project_1/project_1.runs/top_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rst_ps7_0_50M_0.tcl
